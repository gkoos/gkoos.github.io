...
<section id="testimonials" class="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
	<div
	...
	>
		<h2 class="text-sm font-bold tracking-widest text-slate-200 uppercase">Testimonials</h2>
	</div>
	<div>
		<ol class="group/list">
